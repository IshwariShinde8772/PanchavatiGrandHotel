...
export const roomAPI = {
  ...
  listAdminRooms: (params) => axiosInstance.get("/admin/rooms", { params }).then((res) => res.data),
  getReceptionistRoomGrid: () => axiosInstance.get("/receptionist/room-grid").then((res) => res.data),
  markRoomCleaned: (id) => axiosInstance.patch(`/receptionist/rooms/${id}/mark-cleaned`).then((res) => res.data),
