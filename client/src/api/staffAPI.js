...
export const staffAPI = {
  list: (params) => axiosInstance.get("/admin/staff", { params }).then((res) => res.data),
  ...
  listReceptionist: (params) => axiosInstance.get("/receptionist/staff", { params }).then((res) => res.data),
  createReceptionist: (payload) => axiosInstance.post("/receptionist/staff", payload).then((res) => res.data),
};
