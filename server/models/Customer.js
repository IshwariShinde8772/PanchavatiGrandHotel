...
module.exports = (sequelize) => sequelize.define(
  "Customer",
  {
    ...
    id_type: {
      type: DataTypes.ENUM("aadhaar", "passport", "national_id", "driving_license", "other"),
    },
    id_number: { type: DataTypes.STRING },
    id_expiry: { type: DataTypes.DATEONLY },
    id_doc_url: { type: DataTypes.TEXT },
    id_doc_public_id: { type: DataTypes.STRING },
    live_photo_url: { type: DataTypes.TEXT },
    live_photo_public_id: { type: DataTypes.STRING },
