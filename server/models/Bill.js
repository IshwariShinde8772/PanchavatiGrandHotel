...
module.exports = (sequelize) => sequelize.define(
  "Bill",
  {
    ...
    extension_json: { type: DataTypes.JSON },
    original_stay_amount: { type: DataTypes.DECIMAL(10, 2), allowNull: false, defaultValue: 0 },
    original_paid_amount: { type: DataTypes.DECIMAL(10, 2), allowNull: false, defaultValue: 0 },
    total_paid_amount: { type: DataTypes.DECIMAL(10, 2), allowNull: false, defaultValue: 0 },
